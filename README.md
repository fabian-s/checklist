...
code (i.e., come to grips with me being uptight and obsessive-compulsive).  
...
#> /home/lmmista-wap218/lehre/checklist/inst/examples/bad format and filename.r
#> ^                                                     ~      ~   ~
...
#> ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#> bad_format.R:2:15: style: Use <-, not =, for assignment.
#> anonymous_fun = function(buckelName){
#>               ^
...
#> Checking usage in file <bad_format.R>:
...
#> usage: warning in rmvnorm(1, m = c(x, y)): partial argument match of 'm' to 'mean' (~/checklist/inst/examples/usage.R:8)
#> usage: possible error in rmvnorm(1, m = c(x, y)): argument 2 matches multiple formal arguments (~/checklist/inst/examples/usage.R:8)
#> usage: no visible binding for global variable 'global' (~/checklist/inst/examples/usage.R:12)
#> usage: local variable 'assigned_but_unused' assigned but may not be used (~/checklist/inst/examples/usage.R:11)
...
#> (But: some of the lints and alerts above may also be false positives. Use your judgement.
...
#> Did you try to avoid conditional complexity? (no 'else', early exits, etc..)
